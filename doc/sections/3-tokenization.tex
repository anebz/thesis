...
Let's consider a simple corpus with a single line, with the desired subword vocabulary size=10 for example. The character \emph{'\_'} marks the beginning of each word. The following code shows the steps 1-3.
